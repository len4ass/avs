.text
    ...
    read_array_from_file:
        ...
        cmp rax, 0                              # Сравниваем полученный указатель на поток с nullptr
        je .failed_fopen                        # Если указатель на поток nullptr, то прыгаем на метку failed_fopen
        ...
        .failed_fopen:
        xor eax, eax                            # Указываем возвратное значение nullptr, поскольку не удалось чтение
