.text
    ...
    generate_array:
        ...
        jl .set_null_ptr                        # Если < 0, то размер некорректен, указываем на то что генерация не удалась 
        ...
        mov rcx, 10000                          # Указываем число, на которое делим
        div rcx                                 # Беззнаково делим случайное число на 10000 
